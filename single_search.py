...
config = {
  ...
  "params": {
    "start_time": "2020-05-28T00:00:00Z",
    #"end_time": "2021-07-07T10:41:00Z",
    "query": "(vindkraft OR vindmøller OR havvind OR vindmøllepark) -is:retweet lang:no has:geo lang:no",
    "max_results": 10, #it seems like you also have to change the other two places where max_results are listed below
...
def search_tweets(next_token=None):
    tweet_params = {'max_results': 10}  #THIS IS PER REQUEST! YOU CAN'T HAVE MORE THAN THIS PER REQUEST
